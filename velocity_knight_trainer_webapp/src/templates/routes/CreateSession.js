...
export function CreateSession() {
    ...
    function selector(_id, _length) {
        return <select name={_id} onChange={handleChange}>
    ...
    return (
        <>
            <h2 className="create-new-session-header  
             m-auto-hor d-flex center-content ">CREATE NEW SESSION</h2>
            <form className="create-session-form flex-col m-auto-hor">
                <div className="session_name_cont d-flex wrap">
                    <label htmlFor="session_name"
                        className="fw-bold d-flex center-content">Session Name</label>
                ...
                <div className="exercise_cover flex-col">
                    <div className="session_exercise_cont j-sb">
                        <div className="session_type d-flex wrap">
                            <label htmlFor="session_type"
                                className="fw-bold d-flex center-content">Session Mode</label>
                            ...
                            <input value={session_type} onChange={handleChange}
                                name="session_type" hidden type='text' />
                        </div>
                    ...
                    {Array.from(Array(exercise_count)).map((c, index) => {
                        return <div className="exercise_cont_bg">
                            <div key={c} className="exercise_cont fill 
                            d-flex wrap">
                                <label htmlFor="exercise_name" className="exercise_index fw-bold d-flex center-content">
                                ...
                                <div className="exercise_name_cont flex-col j-sb">
                                    ...
                                    <input className="exercise_name_input" onChange={handleChange}
                                        defaultValue={typeof '' === 'object' ? '' : ''}
                                        name={'exercise_name' + index} type='text' />
                                </div>
                                ...
                                <div className="total_rest_cont flex-col sb">
                                    ...
                                    <input onChange={handleChange} name={'rest' + index}
                                        className="duration" type="text" />

                                </div>
                                {session_type == 'track' ?
                                    <div className="intervals_cont flex-col sb">
                                        <h4 className="d-flex w-100 center-content">Interval</h4>
                                        <input onChange={handleChange} name={'intervals' + index} className="duration" type="text" />
                                    </div> : true}
                                {session_type == 'track' ?
                                    <div className="intensity_cont flex-col sb">
                                        <h4 className="d-flex w-100 center-content">Intensity</h4>
                                        <input className="intensity" name={'intensity' + index} type="text" />
                                    </div> : true}
                ...
                <div className="instructions_cont flex-col sb">
                    <h4 className="d-flex w-100 center-content">Addintinal Instructions</h4>
                    <textarea className="instructions" maxLength={100} rows={10} cols={10} name={'instructions'} type="text" />
                </div>
